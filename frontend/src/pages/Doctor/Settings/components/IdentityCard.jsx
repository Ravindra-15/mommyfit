...
const IdentityCard = () => {
  ...
  return (
    <form
      ...
      className="bg-white rounded-2xl border border-[#EFE2E8]shadow-[0_1px_3px_rgba(16,24,40,0.04)] p-6 sm:p-8"
      noValidate
    >
      {/* Card header */}
      <div className="flex items-center gap-3 pb-5 mb-6 border-b border-[#EFE2E8]">
        <div className="w-10 h-10 rounded-lg bg-[#FBEAF1] flex items-center justify-center">
      ...
      <div className="space-y-5">
        ...
        <div>
          ...
          <input
            ...
            className="w-full px-4 py-3 bg-white border border-[#F0D9E2] rounded-xl text-sm text-[#1F2937] placeholder-gray-400 focus:outline-none focus:border-[#E27BA3] focus:ring-1 focus:ring-indigo-500 disabled:bg-[#FBEAF1]disabled:cursor-not-allowed transition-colors"
          />
        </div>
        ...
        <div>
          ...
          <input
            ...
            disabled
            readOnly
            className="w-full px-4 py-3 bg-[#FBEAF1]border border-[#F0D9E2] rounded-xl text-sm text-[#6B7280] cursor-not-allowed"
          />
        ...
        <div>
          ...
          <div
            className={`quill-wrapper bg-white border border-[#F0D9E2] rounded-xl overflow-hidden focus-within:border-[#E27BA3] focus-within:ring-1 focus-within:ring-indigo-500 transition-colors ${
        ...
        <div>
          ...
          <textarea
            ...
            className="w-full px-4 py-3 bg-white border border-[#F0D9E2] rounded-xl text-sm text-[#1F2937] placeholder-gray-400 focus:outline-none focus:border-[#E27BA3] focus:ring-1 focus:ring-indigo-500 disabled:bg-[#FBEAF1]disabled:cursor-not-allowed transition-colors resize-none"
          />
        ...
        <div>
          ...
          <input
            ...
            disabled={submitting}
            placeholder="e.g., 12"
            className="w-full px-4 py-3 bg-white border border-[#F0D9E2] rounded-xl text-sm text-[#1F2937] placeholder-gray-400 focus:outline-none focus:border-[#E27BA3] focus:ring-1 focus:ring-indigo-500 disabled:bg-[#FBEAF1]disabled:cursor-not-allowed transition-colors [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
          />
        </div>
      </div>

      {/* Submit + saved indicator */}
      <div className="mt-7 pt-5 border-t border-[#EFE2E8]flex items-center justify-between gap-4">
        ...
        <button
          ...
          className="inline-flex items-center justify-center gap-2 px-6 py-3 rounded-xl text-sm font-semibold text-white bg-gradient-to-r from-[#E27BA3]to-purple-600 hover:from-indigo-700 hover:to-purple-700 active:scale-[0.99] transition-all shadow-[0_4px_14px_rgba(79,70,229,0.35)] disabled:opacity-50 disabled:cursor-not-allowed disabled:active:scale-100"
        >
          {submitting ? (
            <>
