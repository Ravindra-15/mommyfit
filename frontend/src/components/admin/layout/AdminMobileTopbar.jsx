...
const AdminMobileTopbar = ({ onMenuClick }) => {
  return (
    <header className="lg:hidden sticky top-0 z-30 bg-white border-b border-[#F0D9E2] px-4 py-3 flex items-center justify-between">
      ...
      <div className="flex items-center gap-2">
        <div className="w-8 h-8 rounded-lg bg-[#E27BA3] flex items-center justify-center">
