    ...
    (async () => {
      try {
        ...
        if (mounted) {
          ...
          console.log("CREDITS DEBUG:", { id, planFreeConsults: profile?.planFreeConsults });
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        console.log("SUB DEBUG:", { id, sub, tenure: sub?.tenure, isActive: sub?.isActive });
        if (!mounted) return;
    ...
    <div className="min-h-screen bg-[#F6F8FC] flex flex-col">
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
          <div className="bg-white rounded-3xl shadow-2xl w-full max-w-md px-7 py-8 text-center relative">
            ...
            <button
              ...
              className="inline-flex items-center justify-center gap-1.5 px-6 py-2.5 rounded-full text-sm font-semibold text-white bg-[#E27BA3] hover:bg-[#D86A95] transition-colors"
            >
              Renew Now
            </button>
          </div>
      ...
      <style>{`
        @keyframes consultBlink {
          0%, 100% { border-color: #F4C8D8; box-shadow: 0 0 0 0 rgba(226,123,163,0); }
          50% { border-color: #E27BA3; box-shadow: 0 0 0 4px rgba(226,123,163,0.15); }
        }
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-5">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
              <div className="flex-1 min-w-0">
                ...
                <button
                  ...
                  className="mt-5 flex items-center gap-2 bg-[#E27BA3] hover:bg-[#D86A95] text-white text-sm font-semibold px-6 py-2.5 rounded-full shadow-[0_8px_20px_rgba(226,123,163,0.22)] transition-all duration-200"
                >
          ...
          {/* <div className="bg-white rounded-[28px] border border-[#EFE2E8] shadow-[0_10px_30px_rgba(15,23,42,0.05)] p-6">
            ...
            {allUpcoming.length > 0 ? (
              <div className="bg-[#FBF3F7] rounded-2xl px-5 py-4 border border-[#EFE2E8] flex items-center justify-between gap-3">
                <div className="min-w-0">
                  <p className="text-xs text-[#6B7280] flex items-center gap-1 mb-1">
                    <Bell size={11} className="text-[#E27BA3]" />
                    Upcoming Check-in
                  </p>
                ...
                <button
                  ...
                  className="text-xs font-semibold text-[#E27BA3] hover:underline shrink-0"
                >
                  View all
                </button>
              </div>
            ) : (
              <div className="bg-[#FBEAF1] rounded-2xl px-5 py-4 text-center border border-[#EFE2E8]">
          ...
          <div className="bg-white rounded-[28px] border border-[#EFE2E8] shadow-[0_10px_30px_rgba(15,23,42,0.05)] p-5 sm:p-6">
            <div className="flex items-center gap-2 mb-1">
              <div className="w-7 h-7 bg-[#FBF3F7] rounded-lg flex items-center justify-center">
                <Stethoscope size={15} className="text-[#E27BA3]" />
              </div>
              <span className="font-semibold text-[#1F2937] text-sm">
