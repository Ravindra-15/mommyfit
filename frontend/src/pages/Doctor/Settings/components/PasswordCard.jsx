...
const getStrengthLevel = (checks) => {
  ...
  if (score === 2) return { level: 2, label: "Fair", color: "bg-[#E27BA3]" };
...
const PasswordCard = () => {
    ...
    <div>
      ...
      <div className="relative">
        ...
        <input
          ...
          className={`w-full pl-11 pr-11 py-3 text-sm rounded-xl border bg-white text-[#1F2937] placeholder-gray-400 focus:outline-none focus:ring-1 transition-colors disabled:bg-[#FBEAF1]disabled:cursor-not-allowed ${
            error
              ? "border-red-300 focus:border-red-400 focus:ring-red-300"
              : "border-[#F0D9E2] focus:border-[#E27BA3] focus:ring-indigo-500"
          }`}
        />
        <button
          type="button"
  ...
  return (
    ...
    >
      ...
      {/* Submit */}
      <div className="mt-7 pt-5 border-t border-[#EFE2E8]flex justify-end">
        <button
          type="submit"
