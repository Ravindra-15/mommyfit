...
const ConsultationCard = ({
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-3 p-3 rounded-xl  bg-[#FBF3F7]  border border-[#F0D9E2]">
        <div className="w-12 h-12 rounded-full overflow-hidden border border-white bg-gradient-to-br from-[#FBEAF1] to-[#F7E8EE] flex-shrink-0">
          {photoUrl ? (
            <img
              src={photoUrl}
        ...
        <div className="min-w-0 flex-1">
          <div className="flex items-center gap-1">
            ...
            <CheckCircle2 size={13} className="text-[#E27BA3] flex-shrink-0" />
          </div>
          {doctor?.domain && (
      ...
      <div className="grid grid-cols-2 gap-3 mt-4">
        ...
        <div className="border border-[#F0D9E2] rounded-xl px-3 py-2.5">
          <div className="flex items-center gap-1.5 text-[11px] text-[#6B7280] font-semibold tracking-wide uppercase">
            <Clock size={11} />
            Time
          </div>
      ...
      {showTotals && typeof fee === "number" && (
        <div className="mt-5 pt-4 border-t border-[#EEF2F7] space-y-2">
          ...
          <div className="flex items-center justify-between text-sm">
            ...
            <span className="font-bold text-[#E27BA3] text-base">${fee}</span>
          </div>
        </div>
      )}
    </div>
