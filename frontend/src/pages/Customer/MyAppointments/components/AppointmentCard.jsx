        ...
        <div className="flex flex-col items-end gap-1.5 flex-shrink-0">
          ...
          {canCancel && !alreadyRescheduled && (
            <button
              ...
              className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-medium text-[#E27BA3] border border-[#E27BA3]/30 hover:bg-[#FBEAF1] transition-colors disabled:opacity-50"
            >
              {rescheduling ? (
                <Loader2 size={12} className="animate-spin" />
              ) : (
