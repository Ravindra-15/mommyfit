    ...
    <div className="min-h-screen bg-[#FBEAF1]flex flex-col">
      ...
      <main className="flex-1 py-14 sm:py-20">
        <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 pt-2 sm:pt-4 pb-10 space-y-6">
              ...
              {successImage ? (
                ...
                <div
                  className="
                    ...
                    "
                >
                  <PartyPopper size={32} className="text-[#E27BA3]" />
          ...
          {/* ============================================ */}
          {loading ? (
            <div className="bg-white rounded-2xl border border-[#EFE2E8]p-6 animate-pulse h-56" />
          ) : error || !appointment ? (
              ...
              <div className="flex justify-center">
                <button
                  ...
                  className="
                    ...
                    text-sm font-semibold text- [#D86A95]
                    hover:underline
                    transition-colors
                  "
                >
