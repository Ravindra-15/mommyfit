...
export default function MyProfile() {
 ...
 // const fullPhone = user?.whatsapp ? `+${user.whatsapp}` : "—";
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-[#FBEAF1]flex items-center justify-center">
  ...
  return (
    <div className="min-h-screen bg-[#FBEAF1]flex flex-col">
      ...
      <main className="flex-1 max-w-[1400px] w-full mx-auto px-4 sm:px-6 lg:px-10 py-8">
        ...
        {/* 👤 PROFILE CARD */}
        {/* ============================================ */}
        <div className="bg-white rounded-2xl border border-[#EFE2E8]shadow-[0_1px_3px_rgba(16,24,40,0.04)] p-6 sm:p-8 mb-6">
          {/* PHOTO */}
          <div className="flex flex-col items-center mb-6">
            <div className="relative">
              <div
                onClick={handlePhotoClick}
                className="w-24 h-24 rounded-full bg-gray-100 border border-[#F0D9E2] flex items-center justify-center overflow-hidden cursor-pointer hover:opacity-90 transition-opacity"
              >
                {user?.profilePhoto ? (
                  <img
            ...
            <button
              onClick={handlePhotoClick}
              className="mt-3 text-sm text-[#6B7280] hover:text-[#E27BA3] transition-colors"
            >
          ...
          {/* INFO CARD */}
          <div className="bg-[#FBEAF1]border border-[#EFE2E8]rounded-xl p-5 mb-5">
            <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
              <div className="flex-1 min-w-0">
                ...
                <p className="text-[#E27BA3] text-sm font-medium mt-0.5">
                  {user?.nickName || "—"}
                </p>
              ...
              <div className="flex flex-col gap-2 shrink-0">
                <button
                  ...
                  className="border border-[#F0D9E2] hover:border-[#C7D2FE] hover:text-[#E27BA3] text-[#374151] text-sm font-semibold px-6 py-2.5 rounded-full transition-colors"
                >
                  Edit Profile
                </button>
                ...
                <button
                  ...
                  className="bg-[#E27BA3] hover:bg-[#D86A95] text-white text-sm font-semibold px-6 py-2.5 rounded-full shadow-[0_4px_14px_rgba(226,123,163,0.35)] transition-colors"
                >
          ...
          {/* PRIVACY */}
          <div className=" bg-[#FBF3F7]  border border-[#EFE2E8]rounded-xl p-4 flex items-start gap-3">
            <Shield size={18} className="text-[#E27BA3] shrink-0 mt-0.5" />
        ...
        {/* ⚙️ SETTINGS */}
        {/* ============================================ */}
        <div className="bg-white rounded-2xl border border-[#EFE2E8]shadow-[0_1px_3px_rgba(16,24,40,0.04)] p-6 sm:p-8">
          <div className="flex items-center gap-2 mb-1">
            <Shield size={16} className="text-[#E27BA3]" />
          ...
          <div className="mt-8 pt-6 border-t border-[#EFE2E8]">
            <button
