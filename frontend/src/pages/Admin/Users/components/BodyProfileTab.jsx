...
const SECTION_STYLES = {
  metabolic: { icon: Activity, color: "text-[#E27BA3]", bg: "bg-[#FBEAF1   ]" },
...
const Field = ({ label, value }) => (
  <div className="bg-white border border-[#EFE2E8]rounded-xl px-4 py-3">
...
const EmptyState = () => (
  <div
    className="
      bg-white rounded-2xl border border-dashed border-[#F0D9E2]
