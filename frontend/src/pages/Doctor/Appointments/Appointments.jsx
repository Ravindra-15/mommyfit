...
const ListSkeleton = () => (
  <div className="space-y-3">
    {[1, 2].map((i) => (
      <div
        key={i}
        className="bg-white rounded-2xl border border-[#EFE2E8]p-5 h-44 animate-pulse"
      />
    ))}
  </div>
);
...
// ============================================
const EmptyState = () => (
  <div className="bg-white rounded-2xl border border-dashed border-[#F0D9E2] px-6 py-12 text-center">
    <div className="w-12 h-12 rounded-full bg-[#FBEAF1]flex items-center justify-center mx-auto mb-3">
    ...
    <div className="px-6 lg:px-8 py-8 max-w-6xl mx-auto w-full">
      ...
      >
        <div className="flex items-center gap-2 flex-1 min-w-0">
          <div className="w-9 h-9 rounded-lg bg-[#FBEAF1] flex items-center justify-center flex-shrink-0">
            <CalendarIcon size={16} className=" text-[#E27BA3]" />
          </div>
          <div className="min-w-0">
            <p className="text-xs text-[#6B7280] font-medium">Select Date</p>
            <p className="text-sm font-bold  text-[#E27BA3] mt-0.5">
        ...
        <div className="flex items-center gap-1 flex-shrink-0">
          ...
          <input
            ...
            className="
              ...
              bg-white border border-[#F0D9E2]
              focus:outline-none focus:border-[#E27BA3] focus:ring-1 focus:ring-indigo-500
            "
          />
