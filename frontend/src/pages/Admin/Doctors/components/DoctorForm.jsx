        ...
        <div className="space-y-5">
          ...
          <div>
            ...
            <input
              ...
              className="
                w-full px-4 py-3
                bg-white border border-[#F0D9E2] rounded-xl
          ...
          <div>
            ...
            <div
              className={`
                quill-wrapper
                bg-white border border-[#F0D9E2] rounded-xl overflow-hidden
                focus-within:border-[#E27BA3] focus-within:ring-1 focus-within:ring-indigo-500
                transition-colors
