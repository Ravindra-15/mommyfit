...
// ============================================
const CardSkeleton = () => (
  <div className="bg-white rounded-2xl border border-[#EFE2E8]p-5 sm:p-6 animate-pulse">
...
const EmptyState = ({ onClearFilters }) => (
  <div className="bg-white rounded-[28px] border border-dashed border-[#F0D9E2] px-6 py-16 text-center shadow-sm">
    <div className="w-12 h-12 rounded-full  bg-[#FBF3F7]  flex items-center justify-center mx-auto mb-3">
    ...
    {onClearFilters && (
      <button
        ...
        className="text-xs font-semibold text-[#E27BA3] hover:underline"
      >
        Clear filters
      </button>
    )}
      ...
      <div className="flex items-end justify-between gap-3">
        <div>
          <h2 className="text-lg sm:text-xl font-bold text-[#1F2937] tracking-tight">
            Top Doctors ! <span className="text-[#E27BA3]">Zero Stress</span>
          </h2>
