  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center text-center lg:w-44 flex-shrink-0">
        <div className="w-20 h-20 rounded-full overflow-hidden border border-[#F0D9E2] bg-gradient-to-br from-[#FBEAF1] to-[#F7E8EE]">
          {photoUrl ? (
            <img
              src={photoUrl}
              alt={doctor.fullName}
        ...
        <div className="flex items-center gap-1 mt-3">
          ...
          <CheckCircle2 size={14} className="text-[#E27BA3]" />
        </div>
        {doctor.domain && (
