...
const DateCalendar = ({ selectedDate, onSelect }) => {
  ...
  return (
    <div
      className="
        bg-[#F8FAFF] rounded-[24px] border border-[#EFE2E8]
        p-4 sm:p-5
      "
    >
      ...
      <div className="flex items-center justify-between mb-3">
        <button
          ...
          className="
            ...
            text-[#6B7280] hover:bg-white hover:text-[#E27BA3]
        ...
        <button
          ...
          className="
            w-7 h-7 rounded-lg
            flex items-center justify-center
            text-[#6B7280] hover:bg-white hover:text-[#D86A95]
            disabled:opacity-30 disabled:cursor-not-allowed
            transition-colors
          "
          ...
          return (
            <button
              ...
              className={`
                ...
                ${
                 isSelected
                    ? "bg-[#E27BA3] text-white shadow-[0_8px_18px_rgba(226,123,163,0.22)]"
                    : isToday
                    ? "bg-white text-[#E27BA3] border border-[#C7D2FE]"
                    : disabled
                    ? "text-[#D1D5DB] cursor-not-allowed"
                    : "text-[#374151] hover:bg-white hover:text-[#E27BA3]"
                }
              `}
