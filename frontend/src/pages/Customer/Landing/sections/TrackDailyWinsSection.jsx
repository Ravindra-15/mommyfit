      ...
      <div className="max-w-[1600px] mx-auto px-4 sm:px-8 lg:px-12">
        ...
        <div className="text-center mb-6 sm:mb-8">
          <h2 className="text-[24px] sm:text-[34px] lg:text-[40px] font-bold text-[#2D3D4A]">
            ...
            <span className="text-[#E27BA3]">Under 30 Seconds</span>
          </h2>
        ...
        {/* CARD CONTAINER */}
        <div className="rounded-[28px] sm:rounded-[36px] border border-[#E27BA3] bg-white px-5 sm:px-12 lg:px-20 py-6 sm:py-10 lg:py-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-12 lg:gap-16">
            {/* LEFT — Today card */}
            <div className="flex justify-center lg:justify-start">
              <div className="w-full max-w-[520px] bg-white rounded-2xl border border-[#ECECEC] shadow-[0_12px_35px_rgba(226,123,163,0.16)] px-8 sm:px-10 py-9 sm:py-11">
