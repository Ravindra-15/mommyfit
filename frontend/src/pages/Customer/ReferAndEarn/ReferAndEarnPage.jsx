          ...
          <div className="relative overflow-hidden bg-white rounded-3xl border border-[#EFE2E8]px-6 sm:px-12 py-10 sm:py-14 mb-10">
            ...
            <div className="relative z-10 mt-10 sm:mt-14">
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 sm:gap-4 relative">
                ...
                <div
                  className="hidden sm:block absolute top-6 left-[16.66%] right-[16.66%] border-t-2 border-dashed border-[#F0D9E2]"
                  aria-hidden
                />
          ...
          <div className="bg-white rounded-3xl border border-[#EFE2E8]shadow-[0_10px_30px_rgba(15,23,42,0.05)] px-6 sm:px-10 py-10 sm:py-12 mb-10">
            ...
            <div className="max-w-2xl mx-auto">
              <div className="flex flex-col sm:flex-row items-stretch gap-3">
                ...
                <button
                  onClick={handleCopy}
                  className="inline-flex items-center justify-center gap-2 px-7 py-4 bg-[#E27BA3] hover:bg-[#D86A95] text-white text-sm font-semibold rounded-full shadow-[0_4px_14px_rgba(226,123,163,0.3)] transition-colors whitespace-nowrap"
                >
                  {copied ? (
                    <>
                      <Check size={15} />
              ...
              <div className="flex items-center gap-3 my-6">
                <div className="flex-1 border-t border-[#EFE2E8]" />
              ...
              <button
                ...
                className="w-full inline-flex items-center justify-center gap-2 px-4 py-3 sm:px-6 sm:py-4 bg-[#E27BA3] hover:bg-[#D86A95] text-white text-sm sm:text-xl font-semibold rounded-full shadow-[0_4px_14px_rgba(226,123,163,0.3)] transition-colors"
              >
...
const StepCircle = ({ icon: Icon, title, subtitle }) => (
  <div className="flex flex-col items-center text-center relative z-10">
    <div className="w-12 h-12 rounded-full bg-white border border-[#F0D9E2] flex items-center justify-center shadow-sm mb-3">
...
const ProgressCard = ({ icon: Icon, label, value, highlight, footer }) => {
  if (highlight) {
    return (
      <div className="bg-gradient-to-br from-[#E27BA3] to-[#D86A95] rounded-2xl p-8 sm:p-10 text-white shadow-[0_12px_35px_rgba(226,123,163,0.22)] flex flex-col items-center justify-center min-h-[300px]">
  ...
  return (
    <div className="bg-white rounded-2xl border border-[#EFE2E8]shadow-[0_4px_20px_rgba(16,24,40,0.06)] p-8 sm:p-10 flex flex-col items-center justify-center min-h-[240px]">
