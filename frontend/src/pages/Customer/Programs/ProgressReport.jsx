        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
          ...
          <div className="flex items-center gap-3 mb-1">
            <button
              ...
              className="text-[#6B7280] hover:text-[#E27BA3] transition-colors"
              aria-label="Back"
            >
              <ArrowLeft size={20} />
            </button>
              ...
              {habits.length > 0 && (
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mb-6">
                  {habits.map((h) => (
                    <div
                      key={h.habitId}
                      className="bg-white rounded-2xl border border-[#EFE2E8]shadow-[0_1px_3px_rgba(16,24,40,0.04)] px-4 py-4 text-center"
                    >
                            ...
                            <div className="px-5 pb-5">
                              ...
                              <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
                                {month.habitStats.map((h) => (
                                  <div
                                    key={h.habitId}
                                    className="bg-[#FBEAF1]border border-[#EFE2E8]rounded-xl px-3 py-3 text-center"
                                  >
