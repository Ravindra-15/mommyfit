    ...
    <div className="flex items-center justify-center min-h-[60vh] px-6">
      <div className="text-center max-w-md">
        <div className="inline-flex w-14 h-14 rounded-2xl bg-gradient-to-br from-indigo-50 to-purple-50 items-center justify-center mb-5">
          <Construction className="w-7 h-7  text-[#E27BA3]" strokeWidth={2} />
        </div>
        ...
        <div className="mt-6 inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-[#FBEAF1]  text-[#E27BA3] text-xs font-medium">
          <span className="w-1.5 h-1.5 rounded-full  bg-[#E27BA3]animate-pulse" />
          Coming soon
        </div>
      </div>
    </div>
