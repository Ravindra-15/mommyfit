...
const PLATFORM = "mommyfit"; // current program identifier (change per subprogram)
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <main className="flex-1">
        <div className="max-w-xl mx-auto px-4 sm:px-6 lg:px-8 pt-6 sm:pt-8 pb-10 space-y-6">
          ...
          <button
            type="button"
            onClick={() => navigate(-1)}
            className="inline-flex items-center gap-1.5 text-sm font-medium text-gray-600 hover:text-[#D86A95] transition-colors"
          >
            <ArrowLeft size={16} />
            Back
          </button>
            ...
            <>
              ...
              {problem ? (
                ...
                <div className="bg-white rounded-2xl border border-gray-100 p-4 sm:p-5">
                  <div className="flex items-center justify-between gap-3 mb-2">
                    <div className="flex items-center gap-2 text-sm font-semibold text-gray-900">
                      <FileText size={15} className="text-[#E27BA3]" />
                      Your Problem
                    </div>
                    <button
                      type="button"
                      onClick={openProblemModal}
                      className="inline-flex items-center gap-1 text-xs font-semibold text-[#D86A95] hover:underline flex-shrink-0"
                    >
                      <Pencil size={12} />
                      Edit
                    </button>
                ...
                <button
                  type="button"
                  onClick={openProblemModal}
                  className="w-full inline-flex items-center justify-center gap-2 px-6 py-3 rounded-2xl border border-dashed border-gray-300 text-sm font-medium text-gray-600 hover:border-[#E27BA3] hover:text-[#D86A95] transition-colors bg-white"
                >
                  <FileText size={15} />
              ...
              {bodyProfileLoading ? (
                ...
                <button
                  ...
                  className="w-full flex items-center justify-between gap-3 px-4 sm:px-5 py-4 rounded-2xl border border-gray-100 bg-white hover:border-[#E27BA3] transition-colors"
                >
                ...
                <button
                  type="button"
                  onClick={() => navigate("/body-profile?from=checkout")}
                  className="w-full flex items-center justify-between gap-3 px-4 sm:px-5 py-4 rounded-2xl border border-[#F4C8D8] bg-[#FFF3F7] hover:bg-[#FDE8EF] transition-colors"
                >
                  <span className="flex items-center gap-2.5 text-left">
                    <HeartPulse
                      size={18}
                    ...
                    />
                    <span>
                      <span className="block text-sm font-bold text-[#D86A95]">
                        Complete Your Body Profile
                      </span>
                      <span className="block text-[11px] text-[#E27BA3] mt-0.5">
              ...
              <button
                ...
                className="
                  ...
                  transition-colors
                  shadow-[0_10px_25px_rgba(226,123,163,0.22)]
      ...
      >
        ...
        <textarea
          ...
          className="w-full resize-none rounded-xl border border-gray-200 p-3 text-sm text-gray-800 focus:outline-none focus:ring-2 focus:ring-[#E27BA3] focus:border-transparent"
        />
        ...
        <div className="flex items-center justify-end gap-2 mt-4">
          ...
          <button
            ...
            onClick={saveProblem}
            disabled={!draft.trim()}
            className="px-5 py-2 rounded-full text-sm font-semibold text-white bg-[#E27BA3] hover:bg-[#D86A95] transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          >
            Done
          </button>
        </div>
