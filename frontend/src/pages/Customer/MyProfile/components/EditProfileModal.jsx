        ...
        <form onSubmit={handleSubmit} className="px-6 py-6 space-y-4">
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 pt-4">
            <button
              type="submit"
              disabled={saving}
              className="flex-1 bg-[#E27BA3] hover:bg-[#D86A95] disabled:opacity-60 text-white text-sm font-semibold px-6 py-2.5 rounded-full shadow-[0_4px_14px_rgba(226,123,163,0.35)] transition-colors"
            >
