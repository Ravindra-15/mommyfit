...
export default function PastAppointmentCard({ appointment }) {
  ...
  return (
    <div className="border border-[#EFE2E8]rounded-xl p-4 flex flex-col sm:flex-row sm:items-center gap-4 hover:border-orange-200 transition-colors">
      <div className="w-12 h-12 rounded-full bg-gray-100 border border-[#F0D9E2] flex items-center justify-center shrink-0 overflow-hidden">
        {photoUrl ? (
          <img
            src={photoUrl}
            alt={doctorName}
      ...
      <div className="flex-1 min-w-0">
        <div className="flex items-center gap-1.5">
          ...
          <CheckCircle2 size={14} className="text-[#E27BA3] shrink-0" />
        </div>
        {specialization && (
        ...
        <div className="flex flex-wrap gap-3 mt-3">
          <div className="flex items-center gap-1.5 bg-[#FBEAF1]border border-[#EFE2E8]rounded-lg px-3 py-1.5">
