        ...
        <div className="max-w-[1500px] mx-auto px-5 sm:px-8 lg:px-16 py-12 sm:py-16 lg:py-20">
          ...
          <div className="text-center mb-10 sm:mb-12">
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold tracking-tight">
              ...
              <span className="text-[#E27BA3]">Transparency Center</span>
            </h1>
          ...
          <div className="max-w-3xl mx-auto mb-12 sm:mb-16 text-center">
            <div className="inline-flex items-center justify-center w-10 h-10 rounded-full bg-[#FBEAF1   ] mb-3">
              <ShieldCheck size={20} className="text-[#E27BA3]" />
            </div>
            <p className="text-sm sm:text-base font-semibold text-[#E27BA3] mb-2">
