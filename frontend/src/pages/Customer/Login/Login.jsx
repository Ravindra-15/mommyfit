      ...
      <div className="flex flex-col md:flex-row items-center justify-between px-6 md:px-20 pt-24 md:pt-28 pb-10 md:pb-16 gap-10 md:gap-0">
        ...
        <div className="max-w-[800px] mx-auto md:mx-0 text-center md:text-left px-2">
          <h1 className="text-[38px] md:text-[52px] font-semibold text-teal-900 leading-[1.15]">
            Welcome <br />
            <span className="text-[#E27BA3]">Back to Mommyfit</span>
          </h1>
          ...
          <div className="w-full max-w-[330px] mx-auto flex flex-col gap-4">
            ...
            <input
              ...
              className={`w-full border rounded-xl px-4 py-3 text-[14px] font-normal outline-none transition-colors ${
                errors.email
                  ...
                  : "border-gray-300 focus:border-[#E27BA3] focus:ring-2 focus:ring-orange-200"
              }`}
            />
            ...
            {/* <div className="flex items-center justify-between text-[13px] text-[#6B7280]">
              <label className="flex items-center gap-2 cursor-pointer">
                <input
                  ...
                  className="accent-[#E27BA3] w-4 h-4"
                />
                Remember me
              </label>

              <span className="text-[#E27BA3] hover:underline cursor-pointer">
                Forgot password?
              </span>
            </div> */}
            ...
            <div className="flex justify-end text-[13px]">
              <span
                ...
                className="text-[#E27BA3] hover:underline cursor-pointer"
              >
                Forgot password?
              </span>
            </div>
            ...
            <button
              onClick={handleLogin}
              disabled={loading}
              className="w-full bg-[#E27BA3] hover:bg- [#D86A95] text-white py-3 rounded-full text-[14px] font-medium transition"
            >
