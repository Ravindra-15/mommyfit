...
export default function Receipt() {
  ...
  if (!receipt) {
    return (
      <div className="min-h-screen bg-[#FBEAF1]flex items-center justify-center px-4">
        <div className="text-center">
          <p className="text-[#374151] font-semibold">Receipt not found</p>
          <button
            onClick={() => navigate(-1)}
            className="mt-4 text-sm text-[#E27BA3] hover:text- [#D86A95]"
          >
            Go back
          </button>
        </div>
  ...
  return (
    <div className="min-h-screen bg-[#FBEAF1]py-8 print:bg-white print:py-0">
      <div className="max-w-3xl mx-auto px-4 sm:px-6">
        <div className="flex items-center justify-between mb-6 print:hidden">
          <button
            onClick={() => navigate(-1)}
            className="flex items-center gap-2 text-[#6B7280] hover:text-[#E27BA3] text-sm transition-colors"
          >
            <ArrowLeft size={18} />
            Back
          </button>
          <button
            ...
            className="flex items-center gap-2 bg-[#E27BA3] hover:bg- [#D86A95] text-white text-sm font-semibold px-5 py-2 rounded-full shadow-[0_6px_18px_rgba(79,70,229,0.28)] transition-colors"
          >
            <Printer size={14} />
            Print / Save PDF
          </button>
        ...
        <div className="bg-white rounded-2xl border border-[#EFE2E8]shadow-[0_1px_3px_rgba(16,24,40,0.04)] p-8 sm:p-10 print:shadow-none print:border-0 print:rounded-none">
          {/* HEADER */}
          <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4 pb-6 border-b border-[#EFE2E8]">
            <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 py-6 border-b border-[#EFE2E8]">
            <div>
          ...
          {/* SUMMARY */}
          <div className="py-6 border-b border-[#EFE2E8]">
            <h3 className="text-base font-bold text-gray-800 mb-4">Consultations Summary</h3>
            <div className="overflow-x-auto">
              <table className="w-full text-sm">
                <thead>
                  <tr className="text-left text-xs text-gray-400 border-b border-[#EFE2E8]">
          ...
          {/* TOTAL */}
          <div className="flex items-center justify-between py-5 border-b border-[#EFE2E8]">
          ...
          {/* APPOINTMENT */}
          <div className="mt-6 bg-[#FBEAF1]border border-[#EFE2E8]rounded-xl px-5 py-4 text-center">
            <p className="text-sm text-[#374151]">
