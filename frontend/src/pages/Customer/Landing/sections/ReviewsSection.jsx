...
function ReviewCard({ review }) {
  return (
    <div className="bg-[#FDF6F9]  rounded-2xl border border-[#F7E8EE] shadow-[0_8px_24px_rgba(16,24,40,0.06)] p-5 sm:p-6 flex flex-col gap-3 h-[260px] sm:h-[280px] w-[300px] sm:w-[340px]">
     <span className="text-[#E27BA3] text-6xl font-serif leading-none select-none -mb-2">
        &ldquo;
      </span>
      ...
      <div className="max-w-[1500px] mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-3">
          <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-[#111827]">
            Reviews from <span className="text-[#E27BA3]">Real People</span>
          </h2>
        </div>
