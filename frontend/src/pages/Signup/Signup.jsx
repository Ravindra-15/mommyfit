        ...
        <div className="bg-white rounded-3xl shadow-xl p-6 md:p-8 w-full max-w-md mt-6 md:mt-0">
          ...
          <div className="w-full max-w-[330px] mx-auto flex flex-col gap-4">
            ...
            <input
              ...
              className="w-full border border-gray-300 rounded-xl px-4 py-3 text-[14px] font-normal outline-none focus:border-[#E27BA3]"
            />
            ...
            <label className="flex items-start gap-2.5 text-[12px] text-[#6B7280] cursor-pointer">
              <input
                ...
                className="mt-0.5 accent-[#E27BA3] w-4 h-4 flex-shrink-0"
              />
              <span>
                I agree to Mommyfit's{" "}
                <Link
                  to="/terms-of-use"
                  className="text-[#E27BA3] hover:underline"
                >
                  Terms of Service
                </Link>{" "}
                and{" "}
            ...
            <button
              ...
              className="w-full bg-[#E27BA3] hover:bg-[#D86A95] text-white py-3 rounded-full text-[14px] font-medium transition disabled:opacity-50 disabled:cursor-not-allowed"
            >
            ...
            {/* Facebook */}
            <button className="w-full flex items-center justify-center gap-3 border border-gray-300 rounded-full py-2 text-[14px] font-medium hover:bg-[#FBEAF1 ]">
              <FacebookIcon />
