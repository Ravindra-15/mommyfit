...
export default function ProgramSuccess() {
  ...
  return (
    <div className="min-h-screen bg-[#FBEAF1 ]0/60 flex items-center justify-center px-4 py-12">
      <div className="bg-white rounded-3xl shadow-xl w-full max-w-lg overflow-hidden border-2 border-teal-400">
        ...
        <div className="px-12 py-14 flex flex-col items-center text-center">
          ...
          <p className="text-[#6B7280] text-sm sm:text-base mb-10">
            Welcome to{" "}
            <span className="text-[#E27BA3] font-semibold">{programName}</span>
            {tenure && (
              <>
                {" "}
          ...
          <button
            ...
            className="w-full bg-[#E27BA3] hover:bg- [#D86A95] text-white font-semibold py-3.5 rounded-full transition-colors shadow-[0_6px_18px_rgba(79,70,229,0.28)]"
          >
            Go To Dashboard
          </button>
        </div>
