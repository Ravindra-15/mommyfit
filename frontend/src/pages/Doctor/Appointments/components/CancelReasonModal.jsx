    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40">
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-md p-6">
        ...
        <textarea
          ...
          disabled={loading}
          maxLength={500}
          className="w-full px-3 py-2.5 text-sm text-[#1F2937] bg-white border border-[#F0D9E2] rounded-xl focus:outline-none focus:border-[#E27BA3] focus:ring-1 focus:ring-indigo-500 resize-none disabled:bg-[#FBEAF1 ]"
        />
        ...
        <div className="flex gap-2 mt-5">
          <button
            ...
            onClick={onClose}
            disabled={loading}
            className="flex-1 px-4 py-2.5 rounded-xl text-sm font-semibold text-[#374151] border border-[#F0D9E2] hover:bg-[#FBEAF1]transition-colors disabled:opacity-50"
          >
            Keep Appointment
          </button>
          <button
