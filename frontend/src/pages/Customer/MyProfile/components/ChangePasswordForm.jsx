    ...
    <form onSubmit={handleSubmit} className="space-y-4 max-w-md">
      ...
      <div>
        ...
        <input
          ...
          className="w-full border border-[#F0D9E2] rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:border-[#C7D2FE]"
      ...
      <button
        type="submit"
        disabled={saving}
        className="w-full bg-[#E27BA3] hover:bg-[#D86A95] disabled:opacity-60 text-white text-sm font-semibold px-6 py-2.5 rounded-full shadow-[0_4px_14px_rgba(226,123,163,0.35)] transition-colors"
      >
