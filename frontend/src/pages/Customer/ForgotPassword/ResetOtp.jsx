      ...
      <div className="flex flex-col md:flex-row justify-between items-center px-6 md:px-20 pt-16 md:pt-20 pb-12 gap-8 md:gap-12">
        ...
        <div className="w-full max-w-md text-center md:text-left mx-auto md:mx-0">
          <h1 className="text-4xl md:text-5xl font-bold leading-tight mb-6">
            ...
            <br />
            <span className="text-[#E27BA3]">Password</span>
          </h1>
        ...
        <div className="w-full max-w-md mx-auto md:mx-0 md:mt-12">
          <div className="bg-white rounded-2xl shadow-lg px-6 sm:px-10 py-8 sm:py-10">
            ...
            <div className="flex justify-center gap-2 sm:gap-3 mb-6">
              {otp.map((digit, index) => (
                <input
                  ...
                  onPaste={handlePaste}
                  className="w-11 h-12 sm:w-12 sm:h-14 text-center border border-gray-300 rounded-lg text-xl font-semibold text-gray-800 focus:border-teal-600 focus:ring-1 focus:ring-[#E27BA3] outline-none transition-colors"
                />
              ))}
            </div>
            ...
            <button
              ...
              disabled={loading}
              className="w-full bg-[#E27BA3] hover:bg-[#D86A95] text-white py-3 rounded-full text-[15px] font-medium transition disabled:opacity-50"
            >
            ...
            <p className="text-center text-sm mt-5 text-gray-500">
              {timer > 0 ? (
                ...
                <button
                  ...
                  disabled={loading}
                  className="text-[#E27BA3] font-semibold hover:underline disabled:opacity-50"
                >
                  Resend OTP
                </button>
              )}
