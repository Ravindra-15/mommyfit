...
const CompleteProfile = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-indigo-50/40 to-purple-50/30">
      ...
      {/* 🔝 TOP BAR */}
      {/* ============================================ */}
      <header className="border-b border-[#EFE2E8]bg-white/70 backdrop-blur-sm">
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-[#E27BA3]to-purple-600 flex items-center justify-center shadow-md">
      ...
      <main className="max-w-6xl mx-auto px-6 py-12 sm:py-16">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="flex items-center justify-center gap-2 text-xs font-medium text-[#6B7280] mb-4">
            ...
            <span className=" text-[#E27BA3] font-semibold">Complete profile</span>
            <span className="text-gray-300">›</span>
            <span>Dashboard</span>
          </div>
          ...
          <div className="bg-white rounded-2xl border border-[#EFE2E8]shadow-[0_4px_24px_rgba(16,24,40,0.06)] p-8 sm:p-10">
            ...
            <div className="flex justify-center">
              <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-indigo-50 to-purple-50 flex items-center justify-center">
                <UserCircle2 className="w-7 h-7  text-[#E27BA3]" strokeWidth={2} />
              </div>
            </div>
            ...
            {doctor && (
              <div className="mt-6 rounded-xl bg-[#FBEAF1]border border-[#EFE2E8]p-4">
                ...
                <div className="flex items-start gap-3">
                  {doctor.photo ? (
                    <img
                      ...
                      alt={doctor.fullName}
                      className="w-12 h-12 rounded-full object-cover border border-[#F0D9E2] flex-shrink-0"
                    />
                  ) : (
                    ...
                    {Array.isArray(doctor.specializations) && doctor.specializations.length > 0 && (
                      <div className="flex flex-wrap gap-1 mt-2">
                        {doctor.specializations.slice(0, 4).map((spec) => (
                          <span
                            key={spec}
                            className="inline-block px-2 py-0.5 text-[10px] font-medium bg-white border border-[#F0D9E2] text-[#6B7280] rounded-full"
                          >
                            {spec}
                          </span>
                        ))}
            ...
            <form onSubmit={handleSubmit} className="mt-7 space-y-5" noValidate>
              ...
              <button
                type="submit"
                disabled={isSubmitting}
                className="w-full py-3 rounded-xl text-sm font-semibold text-white bg-gradient-to-r from-[#E27BA3]to-purple-600 hover:from-indigo-700 hover:to-purple-700 active:scale-[0.99] transition-all shadow-[0_4px_14px_rgba(79,70,229,0.35)] disabled:opacity-60 disabled:cursor-not-allowed disabled:active:scale-100 flex items-center justify-center gap-2 mt-2"
              >
                {isSubmitting ? (
                  <>
