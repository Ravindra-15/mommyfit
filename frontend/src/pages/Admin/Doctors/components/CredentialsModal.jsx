  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="px-6 pt-8 pb-4 text-center border-b border-[#EFE2E8]">
            ...
            <div className="relative">
              <input
                ...
                className="
                  ...
                  bg-[#FBEAF1]border border-[#F0D9E2] rounded-xl
        ...
        {/* 🎯 Actions */}
        <div className="px-6 py-5 mt-2 border-t border-[#EFE2E8]flex flex-col-reverse sm:flex-row gap-2.5 sm:justify-between">
          <button
            type="button"
