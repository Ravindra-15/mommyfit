    ...
    <div className="min-h-screen bg-[#FBEAF1]flex flex-col">
      ...
      <main className="flex-1">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-5">
          {/* Greeting Card */}
          <div className="bg-white rounded-[28px] border border-[#EFE2E8]shadow-[0_10px_30px_rgba(15,23,42,0.05)] px-6 py-7 sm:px-8">
          ...
          <div className="bg-white rounded-[28px] border border-[#EFE2E8]shadow-[0_10px_30px_rgba(15,23,42,0.05)] p-6">
            ...
            {nextAppointment ? (
              <div className=" bg-[#FBF3F7]  rounded-2xl px-5 py-4 border border-[#EFE2E8]">
