              ...
              <div className="flex flex-wrap items-center gap-2 shrink-0">
                {subscription.isActive && (
                  <button
                    ...
                    className="inline-flex items-center justify-center gap-2 bg-[#E27BA3] hover:bg-[#D86A95] text-white text-sm font-semibold px-5 py-2.5 rounded-full shadow-[0_4px_14px_rgba(91,79,247,0.25)] transition-colors"
                  >
                    <PlayCircle size={15} />
                    Go to Dashboard
                  </button>
                ...
                {(!subscription.isActive ||
                  ...
                  <button
                    ...
                    className="inline-flex items-center justify-center gap-2 border border-[#E27BA3] text-[#E27BA3] hover:bg-[#F5F7FF] text-sm font-semibold px-5 py-2.5 rounded-full transition-colors"
                  >
                    <RefreshCw size={15} />
                    Renew Program
                  </button>
          ...
          <div className="bg-[#F5F7FF] rounded-2xl border border-[#D9DDF0] p-5 sm:p-6 mb-6">
            ...
            <div className="space-y-2">
              {pendingList.map((p, i) => (
                ...
                >
                  <span className="mt-0.5 w-5 h-5 rounded-full bg-[#EEF2FF] text-[#E27BA3] text-[11px] font-bold flex items-center justify-center shrink-0">
                    {i + 1}
                  </span>
