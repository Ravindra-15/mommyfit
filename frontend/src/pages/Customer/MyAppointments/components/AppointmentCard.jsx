    ...
    <div className="bg-white rounded-xl border border-gray-100 hover:border-gray-200 transition-colors overflow-hidden">
        ...
        <div className="px-4 sm:px-5 pb-4 flex flex-wrap gap-2">
          ...
          {canCancel && !alreadyRescheduled && (
            <button
              ...
              className="inline-flex items-center justify-center gap-1.5 px-4 py-2 rounded-full text-xs font-semibold text-[#E27BA3] border border-[#E27BA3]/30 hover:bg-[#FBEAF1] transition-colors disabled:opacity-50"
            >
              {rescheduling ? (
                <Loader2 size={12} className="animate-spin" />
              ) : (
      ...
      <Modal isOpen={cancelModalOpen} onClose={() => !cancelling && setCancelModalOpen(false)}>
        ...
        <textarea
          ...
          disabled={cancelling}
          className="w-full resize-none rounded-xl border border-gray-200 p-3 text-sm text-gray-800 focus:outline-none focus:ring-2 focus:ring-[#E27BA3] focus:border-transparent disabled:bg-gray-50"
        />
        <div className="text-right text-[11px] text-gray-400 mt-1">
