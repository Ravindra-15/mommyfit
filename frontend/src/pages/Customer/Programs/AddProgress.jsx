      ...
      <main className="flex-1">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
          ...
          <button
            ...
            className="inline-flex items-center gap-1.5 text-sm font-medium text-[#6B7280] hover:text-[#E27BA3] transition-colors mb-5"
          >
            <ArrowLeft size={16} />
            Back to Dashboard
          </button>
          ...
          {/* 📋 Habit sliders */}
          {loading ? (
            <div className="bg-white rounded-[24px] border border-[#EFE2E8]py-16 text-center">
            ...
            <div className="space-y-4">
              {habits.map((habit) => {
                ...
                const color = habit.colorHex || "#E27BA3 ";

                return (
                  <div
                    key={habit._id}
                    className="bg-white rounded-[24px] border border-[#EFE2E8]shadow-[0_8px_24px_rgba(15,23,42,0.04)] p-5 sm:p-6"
                  >
              ...
              <button
                ...
                disabled={saving}
                className="w-full bg-[#E27BA3] hover:bg-[#D86A95] text-white text-sm font-semibold py-3.5 rounded-full shadow-[0_8px_20px_rgba(226,123,163,0.22)] transition-colors disabled:opacity-60 disabled:cursor-not-allowed"
              >
