        ...
        <div className="relative overflow-hidden bg-[#FDF6F9]  rounded-3xl border border-[#EFE2E8]px-6 sm:px-12 py-10 sm:py-14 mb-10">
          ...
          <div className="relative z-10 mt-10 sm:mt-12 text-center">
            <button
              ...
              className="bg-[#E27BA3] hover:bg-[#D86A95] text-white text-sm sm:text-base font-semibold px-10 sm:px-14 py-3 rounded-full shadow-[0_4px_14px_rgba(249,115,22,0.35)] transition-colors"
            >
              Learn More !
            </button>
          </div>
