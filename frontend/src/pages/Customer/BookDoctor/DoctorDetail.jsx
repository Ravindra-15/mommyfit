      ...
      <main className="flex-1">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-6 sm:pt-8 pb-10 space-y-6">
          ...
          <h1 className="text-xl sm:text-2xl font-bold text-[#1F2937] text-center tracking-tight">
            Book Doctor <span className="text-[#E27BA3]">Consultations</span>
          </h1>
          ...
          {/* ============================================ */}
          {doctorLoading ? (
            <div className="bg-white rounded-[28px] border border-[#EFE2E8]p-6 animate-pulse h-44 shadow-sm" />
          ) : doctorError || !doctor ? (
            <div
              className="bg-white rounded-[28px] border border-[#EFE2E8]
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40">
          <div className="bg-white rounded-2xl shadow-xl w-full max-w-sm p-6 text-center relative">
            ...
            <button
              ...
              className="inline-flex items-center justify-center gap-1.5 px-5 py-2 rounded-full text-sm font-semibold text-white bg-[#E27BA3] hover:bg-[#D86A95] transition-colors"
            >
