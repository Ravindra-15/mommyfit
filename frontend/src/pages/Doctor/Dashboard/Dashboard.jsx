...
const StatCard = ({ icon: Icon, label, value, hint, accent }) => {
  const accentMap = {
    indigo: "from-indigo-50 to-indigo-100/50  text-[#E27BA3]",
    blue: "from-blue-50 to-blue-100/50 text-blue-600",
    green: "from-green-50 to-green-100/50 text-green-600",
  };

  return (
    <div className="bg-white rounded-2xl border border-[#EFE2E8]shadow-[0_1px_3px_rgba(16,24,40,0.04)] p-5">
  ...
  return (
    <div className="px-6 lg:px-8 py-8 max-w-7xl mx-auto w-full">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        <div className="lg:col-span-2 bg-white rounded-2xl border border-[#EFE2E8]shadow-[0_1px_3px_rgba(16,24,40,0.04)] p-6">
          ...
          <div className="flex flex-col items-center justify-center py-12 text-center">
            <div className="w-12 h-12 rounded-2xl bg-[#FBEAF1]flex items-center justify-center mb-3">
        ...
        {/* Quick Actions (right) */}
        <div className="bg-white rounded-2xl border border-[#EFE2E8]shadow-[0_1px_3px_rgba(16,24,40,0.04)] p-6">
          <h2 className="text-base font-bold text-[#1F2937]">
            Quick Actions
          </h2>
      ...
      {/* ============================================ */}
      <div className="mt-6 bg-gradient-to-br from-indigo-50 via-white to-purple-50 rounded-2xl border border-[#F0D9E2]p-5 flex items-start gap-4">
        <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-[#E27BA3]to-purple-600 flex items-center justify-center flex-shrink-0">
