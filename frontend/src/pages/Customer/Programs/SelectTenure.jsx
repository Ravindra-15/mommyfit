...
export default function SelectTenure() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-[#F7E8EE ] flex items-center justify-center px-4">
  ...
  if (weeklyPlan && weeks !== null) {
    ...
    return (
      <div className="min-h-screen bg-[#F7E8EE ] px-4 py-10">
        ...
        <div className="bg-white rounded-3xl shadow-xl w-full px-6 sm:px-10 py-9">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-sm text-[#6B7280]">
              {firstName ? (
                <>
                  Hey{" "}
                  <span className="text-[#E27BA3] font-semibold">
                    {firstName}
                  </span>
                  ,{" "}
                </>
          ...
          {/* Selected tenure box */}
          <div className="border border-[#F0D9E2] rounded-2xl px-5 py-4 flex items-center justify-between mb-8 max-w-sm mx-auto">
            <span className="text-sm text-gray-400">Selected Tenure</span>
            <div className="flex items-center gap-2">
              <span className="text-lg font-bold text-[#0F172A]">
                {weeks} Weeks
              </span>
              <Calendar size={20} className="text-[#E27BA3]" />
            </div>
          </div>
          ...
          <div className="px-2 mb-2">
            <input
              ...
              className="w-full accent-[#E27BA3] cursor-pointer"
              style={{
                background: `linear-gradient(to right, #E27BA3  ${pct}%, #E5E7EB ${pct}%)`,
              }}
            />
          </div>
         ...
         {/* Continue */}
          <button
            ...
            className="w-full bg-[#E27BA3] hover:bg-[#D86A95] text-white text-sm font-semibold py-3.5 rounded-full transition-colors shadow-[0_6px_18px_rgba(79,70,229,0.3)]"
          >
            Continue
          </button>
       </div>
            ...
            {fixedPlans.map((plan) => {
              ...
              return (
                <div
                  ...
                  className="border border-[#F0D9E2] rounded-2xl p-5 hover:border-[#E27BA3] hover:shadow-[0_8px_22px_rgba(79,70,229,0.18)] transition-all cursor-pointer flex flex-col"
                >
                  <div className="flex items-center justify-between mb-2">
                    ...
                    {plan.offerBadge && (
                      <span className="bg-[#E27BA3] text-white text-[10px] font-bold px-2 py-0.5 rounded-md">
                        {plan.offerBadge}
                      </span>
                    )}
                  </div>
                  ...
                  <button
                    ...
                    className="mt-auto w-full bg-[#E27BA3] hover:bg-[#D86A95] text-white text-sm font-semibold py-2.5 rounded-full transition-colors shadow-[0_4px_14px_rgba(79,70,229,0.32)]"
                  >
                    Select Plan
                  </button>
                </div>
