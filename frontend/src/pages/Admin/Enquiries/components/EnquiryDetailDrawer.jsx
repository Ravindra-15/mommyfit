...
const EnquiryDetailDrawer = ({ enquiry, onClose }) => {
  ...
  return (
    <>
      ...
      >
        {/* Header */}
        <div className="sticky top-0 bg-white border-b border-[#EFE2E8]px-6 py-4 flex items-start justify-between gap-3">
        ...
        <div className="px-6 py-5 space-y-6">
          ...
          <div>
            ...
            <div className="bg-[#FBEAF1]border border-[#EFE2E8]rounded-xl p-4 min-h-[120px]">
