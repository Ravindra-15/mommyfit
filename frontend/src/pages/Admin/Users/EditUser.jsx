  ...
  if (loading) {
    return (
      <div className="space-y-6">
        ...
        <div className="bg-white rounded-2xl border border-[#EFE2E8]p-6 animate-pulse h-64" />
      </div>
    );
  }
  ...
  if (error || !user) {
    return (
      <div className="space-y-6">
        ...
        <div className="bg-white rounded-2xl border border-[#EFE2E8]px-6 py-16 text-center">
